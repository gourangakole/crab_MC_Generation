...
# with command line options: Configuration/GenProduction/python/B2G-RunIIFall18GS-00005-fragment.py --fileout file:B2G-RunIIFall18GS-00005.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN,SIM --nThreads 8 --geometry DB:Extended --era Run2_2018 --python_filename B2G-RunIIFall18GS-00005_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 975
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/B2G-RunIIFall18GS-00005-fragment.py nevts:975'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:B2G-RunIIFall18GS-00005_3.root'),
...
#            '5100021:m0 = 1000'
	     'FourthTop:All = on',
             '7:m0 = 100000',
	     'FourthGeneration:VtPrimebPrime = 0.0',
             '8:mMin = 490',   
	     '8:m0 = 500',
	     '8:mWidth = 1',
	     '8:onMode = off',
	     '8:oneChannel = 1 0.5 100 6 21',
	     '8:addChannel = 1 0.5 100 6 22',
	     '8:onIfAny = 6'
        ),
